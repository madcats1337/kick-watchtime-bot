...
def generate_provably_fair_result(
    kick_username: str, slot_request_id: int, slot_call: str, chance_percent: float
) -> Dict[str, Any]:
    """
...
def verify_provably_fair_result(
    server_seed: str, client_seed: str, nonce: str, expected_hash: str, expected_random_value: float
) -> bool:
    """
